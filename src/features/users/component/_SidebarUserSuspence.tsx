     ...
     return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <SidebarMenuButton size="lg" className="data-[state=open]:bg-sidebar-accent data-[state=open]:tex-sidebar-accent-foreground">
                    <UserInfo {...user}/>
                    <ChevronsUpDown className="ml-auto grop-data-[state=collapsed]:hidden"/>
                </SidebarMenuButton>
            </DropdownMenuTrigger>
...
function UserInfo({name,email,imageUrl}:User){
    ...
    return(
        <div className=" flex item-center gap-2 overflow-hidden">
